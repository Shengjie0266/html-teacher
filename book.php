    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">';
                ...
                <li class="active"><a href="book.php" style="font-family: cwTeXYen, sans-serif; font-size: 1.3em"> 著作</a></li>
...
<div class="container-fluid text-center">
    ...
    <div align="center">
        <table border="1" style="margin: 20px;border:3px #cbdaf9 double;">
            <?php
            ...
            while ($row = mysqli_fetch_row($result)) {
                ...
                echo "<td style='background: url(img/cloudy-day.png);padding-left: 5px;padding-right: 5px;padding-top: 5px;padding-bottom: 5px;color: rgba(0,0,0,0.7);font-family: Nunito, sans-serif;'>$row[1]</td>";
                echo "</tr>";
            }
            ?>
